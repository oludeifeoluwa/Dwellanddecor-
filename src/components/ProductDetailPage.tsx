...
export const ProductDetailPage: React.FC = () => {
  ...
  const isLiked = typeof isInWishlist === 'function' ? isInWishlist(selectedProduct.id) : false;
          ...
          <div className="lg:col-span-6 space-y-4">
              ...
              >
                ...
                <div className="absolute top-4 right-4 flex items-center gap-2 z-10">
                  ...
                  <button
                    onClick={() => { if (typeof toggleWishlist === 'function') toggleWishlist(selectedProduct.id); }}
              ...
              <div className="space-y-3 pt-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                  <button
                    ...
                    onClick={() => { if (typeof addToCart === 'function') addToCart(productToAddToCart, quantity, selectedColor, selectedSize); }}
              ...
              <div className="relative flex-1 flex items-center justify-center p-2 sm:p-8 overflow-hidden">
                ...
                {galleryImages.length > 1 && (
                  <>
                    <button
                      onClick={handlePrevImage}
                      className="absolute left-2 sm:left-6 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white/20 hover:bg-white/40 text-white backdrop-blur-md flex items-center justify-center transition"
                      aria-label="Previous Image"
                    >
                    ...
                    <button
                      onClick={handleNextImage}
                      className="absolute right-2 sm:right-6 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white/20 hover:bg-white/40 text-white backdrop-blur-md flex items-center justify-center transition"
                      aria-label="Next Image"
                    >
